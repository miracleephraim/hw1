...
contract.info <-read_csv("homework1/CPSC_Contract_Info_2015_12.csv",
skip=1,
...
enroll.info <- read_csv("homework1/CPSC_Enrollment_Info_2015_12.csv",
                       skip=1,
...
write_rds(plan.data,"homework1/data/ma_data_2015.rds")
